...
- Use the lowest comfortable OLED contrast and take regular breaks. Stop for
  eyestrain, headache, nausea, double vision, or difficulty refocusing.
- Do not look at the sun, lasers, or intense light sources through the optics.
- A positive lens can focus sunlight onto the OLED or housing. Fit the opaque
  storage cover and never leave the optical engine facing direct sun.
- The display is not sunlight-readable; a washed-out cue is a reason to stop,
  not to raise brightness indefinitely.
- Fully capture every combiner edge/corner inside the recessed soft radial
  collar, with a separate soft face gasket preventing axial rattle. No bare
  glass may touch a rigid rail or fastener. Never cut,
  drill, grind, or round the sourced coated glass. Apply safety film only if the
  pane vendor permits it and never to the coated face. Polycarbonate is safer
  to fabricate but often has worse ghosting.
...
- Use only a protected 1S LiPo with a documented charge rating of at least
...
- Stop immediately if the cell becomes hot, swollen, soft, creased, punctured,
  smells unusual, or has damaged wiring. Move it away from flammables only if
  that can be done safely and follow local battery-disposal rules.
- Do not wear an unfinished breadboard build or exposed conductors near the face.

Build and use this project at your own risk. The source is provided without a
warranty; see the repository licenses.
